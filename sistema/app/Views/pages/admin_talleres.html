...
<head>
    ...
    <title>administrador talleres</title>
  <link rel="stylesheet" href="admin_talleres.css">
...
<!------------------------------------LOS TALLERES MONITORE DE ADMINISTRADOR-------------------------------------------------------------------------------------------------------->
  <div class="titulos">
<h1 class="titulo">Gestión de talleres</h1>
...
<!-- PANEL DE BUSQUEDA ESPECIALIDAD Y BUSCADOR -->
    <div class="controles">
       <div class="buscador">
  <input type="text" placeholder="Buscar por fecha, nombre o especialidad">
 ...
 <!-- DONDE APARECEN TODOS LOS TALLERES INSANES TIOS -->
  ...
  <div class="infotaller">
    ...
    <p>Fecha de creacion:<span>28/03/2026</span></p>
    <div class="estadot">
    ...
    <!-- GESTION DE ESTADOS -->
<div class="gestion">
      <h2 class="titulo_d" >Estado del taller</h2>
  <hr class="dnaranja">
  <div class="botos">
  ...
  <div class="detalle">
     <h2 class="titulo_t" >Descripción</h2>
  <hr class="lnaranja">
