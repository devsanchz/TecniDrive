...
<section class="profile-card" id="profileCard">
    ...
    <!-- NOTIFICACIONES -->
    <a class="notis" href="<?= site_url('propietario/notificacion') ?>">
        <div class="notificaciones">
            <i class="bi bi-bell-fill campana"></i>
            <small class="noti">0</small>
        </div>
    </a>

    <div class="profile-avatar propietario"
         id="profileAvatar"
...
<!--
    ...
    peticiones fetch() con body JSON (los <form> tradicionales no lo
    necesitan aquí porque ya usan csrf_field() directamente).
-->
<meta name="csrf-name" content="<?= csrf_token() ?>">
<meta name="csrf-hash" content="<?= csrf_hash() ?>">
<script>
    const PERFIL_URL = "<?= site_url('propietario/perfil/actualizar') ?>";
</script>
